...
class DownloadsTab(QWidget):
    ...
    def _setup_ui(self):
        ...
        # active download
        active_group = QGroupBox("活动下载")
        active_layout = QVBoxLayout(active_group)
        self._active_label = QLabel("无活动下载")
        ...
        clear_fail_btn = QPushButton("清除失败")
        ...
        # history
        hist_group = QGroupBox(f"下载历史 ({self._dm.history.count} 条)")
    ...
    def _refresh(self):
        ...
        if active:
            ...
            self._active_label.setText("无活动下载")
            self._progress_bar.setValue(0)
    ...
    def _load_history(self):
        ...
        self._hist_group.setTitle(f"下载历史 ({len(entries)} 条)")
